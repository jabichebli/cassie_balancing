...
%% NEW
% Extract the Model-Based torques
tau_model = tau_full(model.actuated_idx);

% Create a damping torque for the actuated joints
% This opposes velocity (dq) to reduce jitter/oscillation
dq_actuated = dq(model.actuated_idx);
tau_damping = -params.kd_internal .* dq_actuated;

% Combine: Force Control + Joint Damping
