...
switch robot_state
    case 'stage_0'
        ...
        if true
            ...
            if false
                ...
                persist_params.stage1_kp_left = 1800;
                persist_params.stage1_kd_left = 300;
                persist_params.stage1_kp_right = 1800;
    ...
    case 'stage_1'
        ...
        if current_bucket > last_ik_bucket
            ...
            % q1 = solveSingleFootIK(model, 'world', 'left', foot_des(:,1), foot_des(:,2), q1);
            q2 = solveSingleFootIK(model, 'body', 'right', p_target_ankle, p_target_toe, q);
            q1([8, 10, 12, 14, 20]) = q2([8, 10, 12, 14, 20]);
            q1(7) = q1(7) + deg2rad(20 * (1 - exp(-t / 0.5)));
